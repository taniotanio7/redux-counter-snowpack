...
export const App = () => {
  return ___EmotionJSX(React.Fragment, null, ___EmotionJSX("h1", null, "Licznik"), ___EmotionJSX("p", null, "Robi\u0119 to, \u017Ceby\u015B ty nie musia\u0142..."), ___EmotionJSX("hr", null), ___EmotionJSX("div", null), ___EmotionJSX(Display, null), ___EmotionJSX(Change, null));
};
